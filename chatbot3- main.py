...
def main():
    ...
    div[data-testid="stAudioInput"] {
        ...
        z-index: 99999; width: 52px !important;
    }
    ...
    div[data-testid="stChatInput"] {
        position: fixed !important; bottom: 12px !important;
        left: 320px !important; right: 150px !important; z-index: 99998 !important;
    }
    section[data-testid="stMain"] > div:last-child {
        position: fixed; bottom: 0; left: 300px; right: 0;
        height: 75px; background: white;
        border-top: 1px solid #e0e0e0; z-index: 99990;
    }
    </style>
    """, unsafe_allow_html=True)
